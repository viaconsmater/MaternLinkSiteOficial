...
const AboutSection = () => {
  return (
    <div
      id="video"
      className="relative flex w-full items-center justify-center py-10 max-lg:flex-col xl:h-[40rem]"
    >
      <div className="absolute right-0 top-0 w-1/5 rounded-bl-2xl bg-primary-200 max-lg:hidden max-lg:w-1/2 max-md:h-1/4 md:h-1/2 lg:h-3/5 z-[4]" />
      <div className="flex max-w-screen-big items-center gap-10 max-xl:px-6 max-lg:flex-col">
        <div className="flex w-3/5 flex-col justify-center gap-5 py-20 max-lg:w-full max-lg:items-center max-lg:pb-5 max-lg:text-center">
        ...
        <iframe
          ...
          allow="fullscreen;"
          loading="lazy"
          className="z-[5] h-80 w-2/5 rounded-3xl max-xl:h-80 max-lg:w-[85%]"
